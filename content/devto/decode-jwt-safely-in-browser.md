...
Utilio never uploads your token. You can also **share a link** with a test token encoded in the URL — useful for pair debugging.
...
*Originally published on [Utilio Guides](https://utiliio.com/guides/jwt-decoder-online-free).*
