...
export const comparisons: Record<string, Comparison> = {
  ...
  'utillio-vs-cron-tools': {
    ...
    title: 'Utillio vs Online Cron Generators — Parse & Build With Next-Run Preview',
    ...
    intro:
      'Cron generators help you build and validate schedule expressions for backups, CI pipelines, and Kubernetes CronJobs. Utillio\'s Cron workbench combines a visual builder with a parser that shows field breakdowns and the next 5 scheduled runs.',
    utillioPoints: [
    ...
    verdict:
      'Cron syntax errors fail silently in production. Utillio lets you parse existing expressions, preview upcoming runs, and build new ones locally — paste into crontab, Kubernetes, or GitHub Actions with confidence.',
  },
  ...
  'utillio-vs-jwt-io': {
    ...
    title: 'Utillio vs JWT.io — Decode, Verify & Sign Tokens Privately',
  ...
  'utillio-vs-crontab-guru': {
    ...
    title: 'Utillio vs Crontab Guru — Cron Workbench With Next-Run Preview',
    ...
    intro:
      'Crontab Guru is a popular cron expression explainer with human-readable descriptions. Utillio matches that with a Parse tab showing field breakdowns and the next 5 runs, plus a Build tab with presets — all processed locally in the browser.',
    utillioPoints: [
    ...
    verdict:
      'Crontab Guru excels at explaining cron syntax. Utillio adds visual building, next-run preview, and shareable state — keeping infrastructure-sensitive schedules on your device.',
  },
